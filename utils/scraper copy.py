...
def scrape_artstation_user(user_url, driver, WebDriverWait, By,EC):
    ...
    # //div[@class="gallery-container"]/div[@class="gallery"]/div[@class="project artist-profile"]
    artworks = driver.find_elements(By.XPATH, 'div[@class="project artist-profile"]') 
    ...
    #     print('URL.....', artwork.get_attribute('href'))
    #     tweeted = False
